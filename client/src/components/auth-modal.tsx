  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md glass-effect border-white/20">
        ...
        >
          <div className="w-16 h-16 bg-gradient-to-r from-[hsl(333,100%,70%)] to-[hsl(266,68%,73%)] rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <Button
            ...
            className="w-full bg-white text-gray-800 hover:bg-gray-100 font-semibold py-3 px-6 mb-4"
          >
